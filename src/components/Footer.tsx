    ...
    <footer className="bg-black border-t border-white/5 pt-24 pb-12 overflow-hidden text-left">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 grid grid-cols-2 md:grid-cols-5 gap-12 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-3 text-xs text-white/40 font-light">
            <li><Link to="/products" className="hover:text-amber-200 transition-colors">Premium Plywood</Link></li>
            <li><Link to="/products" className="hover:text-amber-200 transition-colors">HDMR Boards</Link></li>
            <li><Link to="/products" className="hover:text-amber-200 transition-colors">Teak Veneers</Link></li>
            <li><Link to="/products" className="hover:text-amber-200 transition-colors">Jagdamba Doors</Link></li>
            <li><Link to="/products" className="hover:text-amber-200 transition-colors">Cabinet Hardware</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-xs text-white/40 font-light font-sans">
            <li><Link to="/brands" className="hover:text-amber-200 transition-colors">Century Ply</Link></li>
            <li><Link to="/brands" className="hover:text-amber-200 transition-colors">Action TESA</Link></li>
            <li><Link to="/brands" className="hover:text-amber-200 transition-colors">Black Cobra</Link></li>
            <li><Link to="/brands" className="hover:text-amber-200 transition-colors">Virgo Laminates</Link></li>
            <li><Link to="/brands" className="hover:text-amber-200 transition-colors">HEPO & Mazix</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-xs text-white/40 font-light">
            <li><Link to="/about" className="hover:text-amber-200 transition-colors">About & Team</Link></li>
            <li><Link to="/projects" className="hover:text-amber-200 transition-colors">Project Gallery</Link></li>
            <li><Link to="/blog" className="hover:text-amber-200 transition-colors">Knowledge Center</Link></li>
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-6 text-[10px] tracking-widest text-white/30 uppercase font-light">
          <Link to="/about" className="hover:text-amber-200 transition-colors">Privacy Policy</Link>
          <Link to="/about" className="hover:text-amber-200 transition-colors">Terms of Service</Link>
        </div>
      </div>
    </footer>
  );
